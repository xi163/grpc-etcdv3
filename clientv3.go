...
func (s *Clientv3) Get(key string, opts ...clientv3.OpOption) (resp *clientv3.GetResponse, e error) {
	return s.cli.Get(s.ctx, key, opts...)
}

func (s *Clientv3) GetCtx(ctx context.Context, key string, opts ...clientv3.OpOption) (resp *clientv3.GetResponse, e error) {
	return s.cli.Get(ctx, key, opts...)
}

func (s *Clientv3) Put(key string, val string, opts ...clientv3.OpOption) (resp *clientv3.PutResponse, e error) {
	return s.cli.Put(s.ctx, key, val, opts...)
}

func (s *Clientv3) PutCtx(ctx context.Context, key string, val string, opts ...clientv3.OpOption) (resp *clientv3.PutResponse, e error) {
	return s.cli.Put(ctx, key, val, opts...)
}

func (s *Clientv3) Watch(key string, opts ...clientv3.OpOption) (c clientv3.WatchChan) {
	return s.cli.Watch(s.ctx, key, opts...)
}

func (s *Clientv3) WatchCtx(ctx context.Context, key string, opts ...clientv3.OpOption) (c clientv3.WatchChan) {
